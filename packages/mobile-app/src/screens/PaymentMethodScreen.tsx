...
const styles = StyleSheet.create({
  ...
  mpCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: semantic.background.primary, borderRadius: radius.lg, padding: spacing[3], gap: spacing[3], borderWidth: 1, borderColor: semantic.border.tertiary },
  mpCardActive: { backgroundColor: semantic.background.successBanner, borderColor: semantic.brand.secondary },
  mpInfo: { flex: 1, gap: spacing[1] },
  ...
  bottomBar: { paddingHorizontal: spacing[4], paddingTop: spacing[3], paddingBottom: spacing[6], borderTopWidth: 1, borderTopColor: semantic.border.tertiary, backgroundColor: semantic.background.primary, gap: spacing[3] },
