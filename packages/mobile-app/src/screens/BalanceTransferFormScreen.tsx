...
const styles = StyleSheet.create({
  ...
  inputWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: semantic.background.primary, borderWidth: 1, borderColor: semantic.border.tertiary, borderRadius: radius.md, paddingHorizontal: spacing[3], paddingVertical: spacing[3], gap: spacing[2] },
  input: { flex: 1, ...require('@pluxee/design-system').typography.body.largeMedium, color: semantic.text.primary },
  amountInput: { ...require('@pluxee/design-system').typography.title.mobileMain, textAlign: 'right' },
