...
const styles = StyleSheet.create({
  ...
  dropdown: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: spacing[3], paddingHorizontal: spacing[4], borderRadius: radius.md, borderWidth: 1, borderColor: semantic.border.tertiary, marginBottom: spacing[2], backgroundColor: semantic.background.primary },
  cardRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: semantic.background.primary, borderRadius: radius.lg, padding: spacing[3], gap: spacing[3], borderWidth: 1, borderColor: semantic.border.tertiary, marginBottom: spacing[2] },
