...
export const MOCK_BRANDS: Brand[] = [
  ...
  },
  {
    ...
    paymentMethod: 'balance_transfer',
    badge: 'ONLINE',
    tagline: 'Tikla Gelsin ile siparis',
    about: 'Tikla Gelsin uygulamasinda Pluxee ile odeme yapabilirsin.',
    appDeepLink: 'tiklagelsin://',
    appStoreUrl: 'https://apps.apple.com/tr/app/t%C4%B1kla-gelsin/id1561284625',
    playStoreUrl: 'https://play.google.com/store/apps/details?id=com.tiklagelsin.app',
  },
];
